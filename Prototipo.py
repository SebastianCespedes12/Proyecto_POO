...
class Particle:
    ...
    def cambiar_velocidad(self, parametro_cognitivo: float, parametro_social:float, mejor_pos_global:list):
        nueva_velocidad = []
        for i in range(len(self.velocidad)):
            ...
            nueva_velocidad.append(self.velocidad[i] + cognitivo + social)
...
class Swarm:
    ...
    def cambiar_velocidades(self, parametro_cognitivo, parametro_social):
        for particula in self.enjambre:
            particula.cambiar_velocidad(parametro_cognitivo, parametro_social, self.mejor_pos_global)
            particula.mover()
...
if __name__ == "__main__":
    ...
    for i in range(50):
        ...
        prueba.cambiar_velocidades(parametro_cognitivo= 2 ,parametro_social= 2)

    print(prueba.mejor_global_encontrado())
